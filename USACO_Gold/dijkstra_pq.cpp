...
const int sz=50001; //Maximum possible number of vertices. Preallocating space for DataStructures accordingly
...
int main() 
{
    int n,m,x,y,w, source;//Number of vertices and edges
    cin>>n>>m >> source;
